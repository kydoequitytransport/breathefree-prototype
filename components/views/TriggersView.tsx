  ...
  return (
    <div className="view active" id="triggers" style={{ padding: '0 22px 24px' }}>
      ...
      {showRiskyForm && (
        <div className="callout" style={{ marginBottom: 12 }}>
          <div className="field" style={{ marginBottom: 10 }}>
            <label>Risky event</label>
            <input
              type="text"
              placeholder="e.g. Work trip with smokers"
              value={riskyEvent}
              onChange={(e) => setRiskyEvent(e.target.value)}
            />
          </div>
          <div className="field" style={{ marginBottom: 10 }}>
            ...
            <input
              type="date"
              value={riskyDate}
              onChange={(e) => setRiskyDate(e.target.value)}
            />
          </div>
          <div className="field" style={{ marginBottom: 12 }}>
            <label>My plan</label>
            <textarea
              rows={3}
              placeholder="If this hits, what will you do instead?"
              value={riskyPlan}
